...
Join my [news channel](https://t.me/teleunitedbots) to get information on all the latest updates.
"""
...
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "If you have any bugs or questions on how to use me, have a look at my [Group](https://t.me/tele_united_bots), or ask to @lead_developer.")

DONATE_STRING = """Heya, glad to hear you want to donate!
It took lots of work for [my creator](t.me/lead_developer) to get me to where I am now, and every donation helps \
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Hello all Join @tele_united_bots.")
